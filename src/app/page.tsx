  ...
  return (
    <>
      ...
      <section className="border-t border-line">
        <div className="gutter mx-auto grid max-w-[1320px] gap-10 py-16 md:py-24 lg:grid-cols-12">
            ...
            {services.map((s) => (
              <li key={s.slug} className="border-b border-line first:border-t">
                <Link
                  ...
                  className="group grid grid-cols-[1fr_auto] items-start gap-x-6 gap-y-2 py-6 sm:py-8 md:grid-cols-[minmax(0,15rem)_1fr_auto]"
                >
                  <span className="font-display text-[clamp(1.4rem,1.15rem+1vw,2rem)] leading-tight font-bold tracking-tight transition-colors group-hover:text-accent-text">
                    {s.short}
                  </span>
      ...
      <section className="gutter mx-auto max-w-[1320px] py-16 md:py-24">
      ...
      {live && (
        <section className="gutter mx-auto max-w-[1320px] py-16 md:py-24">
          ...
          <div className="mt-10 grid gap-6 lg:grid-cols-12">
            ...
            <div className="flex flex-col rounded-[var(--radius-card)] p-7 ring-1 ring-line sm:p-10 lg:col-span-5">
      ...
      <section className="border-t border-line">
        <figure className="gutter mx-auto max-w-[1320px] py-16 md:py-24">
          <div className="max-w-3xl md:ml-[16.66%]">
            {/* TODO(content): founder to confirm or rewrite this note */}
            <blockquote className="font-display text-[clamp(1.5rem,1.2rem+1.3vw,2.25rem)] leading-[1.2] font-bold tracking-tight text-balance">
